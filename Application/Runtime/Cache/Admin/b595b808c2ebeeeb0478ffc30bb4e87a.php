  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="toolbar ue-clear">
        <a href="home.html" target="_self" class="home-btn">首页</a>
      ...
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/Doc/showList">公文列表</a></li>
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/Doc/add">公文添加</a></li>
            </ul>
          </li>
          <li class="nav-info">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>职员管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/User/showList">职员列表</a></li>
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/User/add">职员添加</a></li>
            </ul>
          </li>
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>知识管理</span><i class="icon"></i></a></div>
            <ul class="subnav">
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/Knowledge/showList">知识列表</a></li>
              <li><a href="javascript:;" date-src="/oa/index.php/Admin/Knowledge/add">知识添加</a></li>
            </ul>
          </li>
          <li class="agency">
