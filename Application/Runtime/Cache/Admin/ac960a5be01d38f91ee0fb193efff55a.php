...
<form action="<?php echo U('insert');?>" method="post" id="form1">
	<div class="main">
	    ...
	    <div class="short-input select ue-clear">
	        ...
	        <div class="select-wrap">
	        	<select name="pid">
					...
					<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><option value="<?php echo ($res["pid"]); ?>">
